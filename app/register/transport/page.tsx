...
export default function TransportRegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const latitude = 40.7128 + Math.random() * 0.1
      const longitude = -74.006 + Math.random() * 0.1
      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set up your delivery service profile to start earning</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="per_km_rate">Rate per KM ($) *</Label>
                  <Input
                    id="per_km_rate"
                    type="number"
                    step="0.01"
